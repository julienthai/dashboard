...
import lu.payrollengine.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link lu.payrollengine.domain.Dashboard}.
 */
@RestController
@RequestMapping("/api")
public class DashboardResource {
    ...
    public ResponseEntity<DashboardDTO> updateDashboard(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dashboardDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<DashboardDTO> partialUpdateDashboard(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dashboardDTO.getId())
        );
    }
